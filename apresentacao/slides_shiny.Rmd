...
+ Agora faça utilizando outro dataset, por exemplo, o dataset *mtcars* do prórpio R.
--
...
+ Quando estamos escrevendo com o R, podemos adicionar conteúdo com funções de *marcação*.  [aqui](https://shiny.rstudio.com/articles/tag-glossary.html).
